...
class LoggingAspect extends AbstractAspect implements ProxyAttributeInterface
{
    ...
    public function __construct(
        public bool   $logArguments = true, // 是否记录参数
        public bool   $logResult = true, // 是否记录返回值
        public string $logModule = 'info', // 日志模块
