...
trait PageFrameworkTrait
{
     ...
     * @throws Throwable
     */
    public function frameworkFormRequest(TableInterface $table, TableDtoInterface $dto, array $fields): array
    {
        $ret = [];
        foreach ($fields as $field) {
            ...
            $dto->setByField($field->field, $value);
        }
        return $ret ;
    }
     ...
     * @throws Throwable
     */
    public function frameworkFormEditFill(array $fields, TableDtoInterface $dto): void
    {
        foreach ($fields as $field) {
            $field->frameworkEditFill($dto);
        }
    }
