...
//        File::delDirectory(RUNTIME_DIR . "Protobuf/GPBMetadata/");
     ...
     * @return void
     */
    private static function createBaseExt(): void
    {
...
package Protobuf.$dbName.BaseExt;
option php_metadata_namespace = "GPBMetadata\\\\$dbName";
...
STR;
            File::save(self::saveDir . $dbName . "/BaseExt.proto", $str . PHP_EOL);
        });
    }
    ...
    private function createNamespace(string $upperTableName): void
    {
        ...
        $str .= "import \"BaseExt.proto\";" . PHP_EOL;
    ...
    private function createItemMessage(array $fields, string $tableName): void
    {
        ...
        // 添加扩展字段
        $fields[] = ['Field' => 'ext', 'Type' => "Protobuf.$this->dbName.BaseExt.Ext",];
