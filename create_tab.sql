...
(
    ...
    `key`      text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT '唯一标识',
    `zh`       text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT '中文',
    ...
    `ms`       text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin COMMENT '马来西亚语',
