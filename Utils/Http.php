...
class Http
{
    ...
    private function send(): bool|string
    {
        ...
        if ($errno !== 0) {
            ...
            throw new AppException(LanguageEnum::HTTP_REQUEST_FAILED_WITH_MSG, "error_no:$errno;error_msg:$errorMsg");
        }
    ...
    public function responseArray(): array
    {
        ...
        if (empty($response)) {
            ...
            throw new AppException(LanguageEnum::HTTP_RESPONSE_TYPE_INVALID);
        }
        return $response;
    }
}
